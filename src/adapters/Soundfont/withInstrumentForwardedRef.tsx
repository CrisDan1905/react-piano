import { Component, ComponentClass, forwardRef, ReactNode, Ref } from 'react'
...
export function withInstrument<TProps extends InjectedProps = InjectedProps> (WrappedComponent: ComponentClass<TProps>): any {
  ...
  return forwardRef<ComponentInstance, ProviderProps>((props, ref) => <WithInstrument forwardedRef={ref} {...props} />)
}
